	<?php
			...
			$listing_style = '';
                ...
                ?>
					<div class="<?php echo $listing_layout; ?> <?php echo esc_attr($listing_style); ?> <?php echo esc_attr($adClass); ?> lp-grid-box-contianer view-toggle card1 lp-grid-box-contianer1" data-title="<?php echo get_the_title(); ?>" data-postid="<?php echo get_the_ID(); ?>"   data-lattitue="<?php echo esc_attr($latitude); ?>" data-longitute="<?php echo esc_attr($longitude); ?>" data-posturl="<?php echo get_the_permalink(); ?>">
				...
				<?php 
					if($postGridCount%$postGridnumber == 2 && $listing_layout == 'grid_view'){
