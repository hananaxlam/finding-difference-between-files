...
<script>
    jQuery(document).ready(function(e){
        ...
        jQuery('.user-menu.dashboard-redirect').click(function(e){
            e.preventDefault();
					...
					if(is_user_logged_in()):
						...
						<div class="user-detail-wrap">
							<div class="user-thumb">
								<img class="avatar-circle" src="<?php echo listingpro_author_image(); ?>" />
							</div>
							<div class="user-text">
				...
				<div class="row">
                    ...
                    <div class="lp-search-toggle col-md-2 col-xs-3 pull-right text-right">
                        <?php if( is_front_page() ): ?>
                            ...
                            if(is_user_logged_in()):
                            ?>
                                <a href="<?php echo listingpro_url('listing-author'); ?>" class="user-menu dashboard-redirect"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                            <?php else: ?>
                                <a href="#" class="user-menu md-trigger" data-modal="modal-3"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                            <?php endif; ?>
                        <?php else: ?>
