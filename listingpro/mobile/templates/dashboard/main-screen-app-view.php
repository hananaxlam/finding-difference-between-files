    ...
    <div class="row">
        <div class="col-md-4 col-xs-4 padding-zero">
            <div class="count-box">
                ...
                <p><i class="fa fa-eye"></i> <?php esc_html_e('Total Views','listingpro'); ?></p>
        ...
        <div class="col-md-4 col-xs-4 padding-zero">
            <div class="count-box">
                ...
                <p><i class="fa fa-bullseye"></i><?php esc_html_e('Total Leads','listingpro'); ?></p>
            </div>
        </div>
        <div class="col-md-4 col-xs-4 padding-zero">
            <div class="count-box">
                ...
                <p><i class="fa fa-commenting-o"></i><?php esc_html_e('Total Reviews','listingpro'); ?></p>
            </div>
        </div>
    </div>
</div>
