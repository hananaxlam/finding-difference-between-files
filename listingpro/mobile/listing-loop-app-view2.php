	<?php
			...
			$listing_style = '';
                ...
                ?>
					<div class="list_view  <?php echo esc_attr($adClass); ?> lp-grid-box-contianer card1 lp-grid-box-contianer1" data-title="<?php echo get_the_title(); ?>" data-postid="<?php echo get_the_ID(); ?>"   data-lattitue="<?php echo esc_attr($latitude); ?>" data-longitute="<?php echo esc_attr($longitude); ?>" data-posturl="<?php echo get_the_permalink(); ?>">
                                            ...
                                            $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID()), 'listingpro-thumb4' );
                                                if(!empty($image[0])){
                                                    ...
                                                    <a href="'.get_the_permalink().'" >
                                                        <img src="'.esc_html__('https://placeholdit.imgix.net/~text?txtsize=33&w=272&h=270', 'listingpro').'" alt="">
                                                    </a>';
                                                }
                                        }else {
                                            echo '
