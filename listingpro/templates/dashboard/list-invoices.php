					...
					<div class="invoice-section">
						...
						<?php
							...
							if(!empty($lp_tax_rate)){
								...
								$resultantPriceInt = (int)$resultantPrice;
								$price_purchasedInt = (int)$price_purchased;
						...
						<table class="wp-list-table widefat fixed striped posts">
							...
							<tbody>
								<tr>
									...
									<td><?php echo round($data->price,2).$data->currency; ?></td>
									<?php if($istax==true){ ?>
									<td><?php echo $taxPrice.$data->currency; ?></td>
									<?php } ?>
