							...
							<div class="availableprice_options  padding-top-30">
								<?php if( is_array($levels) && count($levels)>0 ){ ?>
									<div class="checkboxx">
										...
										<?php
											$randAdTip = esc_html__('Random ads will appear on various location through out the site where ever the site-admin has defined. Usually on NON-Directory listing pages such as Home, About Us, Contact us, Blog posts etc.', 'listingpro');
											
											$detailPagTip = esc_html__('The ads are the promoted listings shown on details page on bottom right in a unique design. ', 'listingpro');
											
											$topsearchTip = esc_html__('The ads are shown on the search result or category listing page.', 'listingpro');
										?>
