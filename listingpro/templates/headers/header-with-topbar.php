		...
		<div class="<?php echo esc_attr($headerWidth); ?>">
			<div id="menu" class="small-screen">
				...
				<?php
					if (!is_user_logged_in()) {
						?>
					<a class="lpl-button md-trigger" data-modal="modal-3"><?php esc_html_e('Join', 'listingpro');?></a>
							...
							<div id="slidemenu">   
								...
								<div class="lp-listing-adlisting">
									<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>" class="lpl-button">
										<?php esc_html_e('Add A Listing', 'listingpro'); ?>
									</a>
									<a href="#" class="lpl-button md-trigger" data-modal="modal-3">
										<?php esc_html_e('Join', 'listingpro'); ?>
									</a>
								</div>
								...
								<ul>
									<li>
										<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>">
											...
											<?php echo esc_html__('Add Your Listing', 'listingpro'); ?>
										</a>
									</li>
								</ul>
							</div>
