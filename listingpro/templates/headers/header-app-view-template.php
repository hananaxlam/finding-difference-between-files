			...
			<div id="menu" class="small-screen">
				<?php
					...
					if($showAddListing==true) {
							...
							if(!empty($addURL)) {
							?>
							<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>" class="lpl-button"><?php esc_html_e('4 Add Listing', 'listingpro');?></a>
							<?php 
						}
					}
				?>
		...
		<div id="slidemenu">   
			...
			<div class="lp-listing-adlisting">
				<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>" class="lpl-button">
					<?php esc_html_e('5 Add Listing', 'listingpro'); ?>
				</a>
											...
											<ul>
												<li>
													<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>">
														...
														<?php esc_html_e('6 Add Listing', 'listingpro') ?>
													</a>
												</li>
											</ul>
										</div>
