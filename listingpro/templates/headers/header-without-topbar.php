		...
		<div class="lp-menu-bar <?php echo esc_attr($menuColor);  ?>">
			<div class="<?php echo esc_attr($headerWidth); ?>">
				<div class="row">
					...
					<div class="col-md-4 col-xs-8 lp-logo-container" style="display:flex">
						<div class="lp-logo" style="flex:1">
						...
						<div class="new-store-logo" style="flex:1; align-self:center">
							<a href="https://store.delocus.com">
								<img style="max-width:100%" src="https://delocus.com/wp-content/uploads/2018/06/Store-Delocus-1-e1528936961658.png" class="attachment-full size-full wp-post-image" alt="New! Store" title="New! Store">
							</a>
						</div>
					</div>

					<div class="header-right-panel clearfix col-md-8 col-sm-6 col-xs-12">
						<?php 
							if($headerSrch == 1) {
			...
			<?php echo listingpro_mobile_menu(); ?>    
						...
						<div class="<?php echo esc_attr($menuClass); ?> col-xs-12 lp-menu-container clearfix pull-right">
							<div class="pull-right">
								<!-- <div class="menu-item menu-item-type-taxonomy menu-item-object-listing-category menu-item-1992">
									<a href="https://store.delocus.com">Check out the new store!</a>
								</div> -->
