			...
			<div id="menu" class="small-screen">
				<?php
					...
					if($showAddListing==true) {
							...
							if(!empty($addURL)) {
							?>
							<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>" class="lpl-button"><?php echo esc_html__('Add Your Listing', 'listingpro'); ?></a>
							<?php 
						}
					}
				?>
								...
								<div id="slidemenu">   
									...
									<div class="lp-listing-adlisting">
										<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>" class="lpl-button">
											<?php esc_html_e('AddListing!', 'listingpro'); ?>
										</a>
												...
												<ul>
													<li>
														<a href="<?php echo listingpro_url('add_listing_url_mode'); ?>">
															...
															<?php esc_html_e('Add Restaurant Listing', 'listingpro') ?>
														</a>
													</li>
												</ul>
											</div>
