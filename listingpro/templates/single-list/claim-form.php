				...
				<div class="col-md-7 col-xs-12 padding-0">
					<div class="claim-details">
						...
						<ul>
							...
							<li>
								<i class="fa fa-check-square-o"></i> 
								<?php echo esc_html__('Start recieving messages from lead.', 'listingpro'); ?>
							</li>
						</ul>
						...
						<div class="form-group">
							<input type="text" name="phone" id="phone" placeholder="<?php echo esc_html__('Phone#', 'listingpro'); ?>">
						</div>
						<div class="form-group">
...
<div class="claimform">
	...
	<div class="">
		<form class="form-horizontal"  method="post" id="claimformmobile">
			...
			<div class="form-group">
				<textarea class="form-control textarea1" rows="5" name="message" id="message" placeholder="<?php echo esc_html__('Message:','listingpro');?>"></textarea>
			</div>
			<div class="form-group mr-bottom-0">
