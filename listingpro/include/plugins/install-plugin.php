...
function listingpro_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'source' => get_stylesheet_directory() . '/include/plugins/redux-framework.zip',
            'required' => true,
            'version' => '',
            'force_activation' => false,
            'force_deactivation' => false
		...
		array(
            ...
            'source' => get_stylesheet_directory() . '/include/plugins/listingpro-plugin.zip',
            'required' => true,
            'version' => '',
            'force_activation' => false,
            'force_deactivation' => false
		...
		array(
            ...
            'source' => get_stylesheet_directory() . '/include/plugins/listingpro-reviews.zip',
            'required' => true,
            'version' => '',
            'force_activation' => false,
            'force_deactivation' => false
		...
		array(
            'name' => 'Listingpro ADs',
            'slug' => 'listingpro-ads',
            'source' => get_stylesheet_directory() . '/include/plugins/listingpro-ads.zip',
            'required' => true,
            'version' => '',
            'force_activation' => false,
            'force_deactivation' => false
