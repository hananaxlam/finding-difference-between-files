    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'switch',
                'title'    => __( 'Password Feild For User SignUp Form', 'listingpro' ),
			...
			array(
				...
				'type'     => 'select',
				'title'    => __('Select API for Current location', 'listingpro'), 
				'subtitle' => __('', 'listingpro'),
				'desc'     => __('Above API options are used to identify visitors current location by their ip address . Select one of the API of your choice which fulfill your need .', 'listingpro'),
				'options'  => array(
					'geo_ip_db' => 'Geo IP DB',
					'ip_api' => 'IP API',
				),
		...
		Redux::setSection( $opt_name, array(
			...
			'fields'     => array(
				...
				array(
                    ...
                    'type'     => 'select',
                    'title'    => __('Listing Mobile View', 'listingpro'),
				...
				/* array(
					'id'       => 'slider_height_responsive',
					'type'     => 'text',
					'title'    => __( 'Slider height for mobiles', 'listingpro' ),
					'subtitle' => __( 'Add Slider Height (without unitPixel/Percent)', 'listingpro' ),
					'required' => array( 
						array('lp_detail_slider_styles','equals','style2') 
					),
		...
		Redux::setSection( $opt_name, array(
			...
			'fields'     => array(
				...
				array(
					...
					'subtitle' => __('Choose an option', 'listingpro'),
					'desc'     => __('Available options are single/multi cetegory', 'listingpro'),
					'options'  => array(
						'single' => 'Single',
						'multi' => 'Multi',
					),
