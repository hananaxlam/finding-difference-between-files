...
//============================================ Harry Code ==================================================//
	...
	jQuery('.listing-app-view .listing-app-view-bar .pricy-form-group #lp-find-near-me ul > li > a').click(function() {
	...
	if(jQuery('body').hasClass('home')){
		jQuery('.listing-app-view.home .map-view-list-container2').slick({
                         centerMode: false,
						 centerPadding: '0px',
						 infinite: false,
						 speed: 100,
			...
			jQuery('.listing-app-view.home .map-view-list-containerlist').slick({
                        centerMode: false,
						 centerPadding: '0px',
						 infinite: false,
						 speed: 100,
			...
			jQuery('.listing-app-view.home .lp-location-slider').slick({
                        centerMode: false,
						 centerPadding: '0px',
						 infinite: false,
						 speed: 100,
  ...
  var LPpostID  = jQuery(this).closest('.lp-grid-box-contianer').data("postid");
        ...
        jQuery.ajax({
            ...
            success:function(data) {
             ...
             var ad_markup = '';
             var rate_markup = '0 Reviews';
                if(data.adStatus == 'active')
                {
                    ad_markup = '<span class="listing-pro">Ad</span>';
                }
                if(data.rate != ''){
     ...
     '<div class="lp-grid-desc-container lp-border clearfix">' +
      '<div class="lp-grid-box-description ">' +
       '<div class="lp-grid-box-left pull-left">' +
        ...
        '<ul>' +
         '<li>'+ rate_markup +'</li>' +
         '<li class="middle">' + data.pricey +'</li>' +
         '<li>' + data.cats_markup +'</li>' +
         '<li>' +
...
jQuery('li.lp-tooltip-outer').on('click', function(){
	...
	jQuery(this).find('.lp-tooltip-div').css({
		'opacity': '1',
		'visibility': 'visible',
		'top': '100%',
		'z-index': '9999'
