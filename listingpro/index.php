			...
			<div class="row">
                ...
                if( $blog_template == 'left_sidebar' )
                {
					...
					if( $blog_sidebar_style == 'sidebar_style1' ){
                        echo '<div class="col-lg-4 col-md-4 sidebar-container"><div class="sidebar-style1">';
                            get_sidebar();
                        echo '</div></div>';
						}else{
							 echo '<div class="col-lg-4 col-md-4 sidebar-container"><div class="sidebar-style2">';
							get_sidebar();
							echo '</div></div>';
                ...
                {
                   if( $blog_sidebar_style == 'sidebar_style1' ){
                        echo '<div class="col-lg-4 col-md-4"><div class="sidebar-style1">';
                            get_sidebar();
                        echo '</div></div>';
						}else{
							 echo '<div class="col-lg-4 col-md-4"><div class="sidebar-style2">';
							get_sidebar();
							echo '</div></div>';
